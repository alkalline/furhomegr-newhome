...
<html lang="<?=$meta_lang?>">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						...
						<a href="shop/el/dermatina-xalia-5" class="btn btn-shop">Δερμάτινα<br>χαλιά</a>
            <a href="shop/el/moderna-dermatina-xalia-38" class="btn btn-shop">Μοντέρνα<br>χαλιά</a>
						<?php } elseif (LANG=='ru') { ?>
  ...
  <div id="floating-buttons">
    <a href="#" class="btn" id="btn-float-offer">Top</a>
  </div>
